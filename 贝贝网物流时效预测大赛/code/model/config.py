...
class Config(object):
    def __init__(self):
        ...
        self.MODEL_FILE_NAME1 = 'model2.pkl'
        self.MODEL_SAVE_FOLDER  =       './model/'
        self.MODEL_SAVE_PATH    =       self.MODEL_SAVE_FOLDER + self.MODEL_FILE_NAME
        self.MODEL_SAVE_PATH1 = self.MODEL_SAVE_FOLDER + self.MODEL_FILE_NAME1
        self.LR                 =      0.8 * 1e-3  # default learning rate
        ...
        self.OUTPUT_TIME_INTERVAL_4  =   10
    ...
    def get_lr(self, epoch):
        ...
        #     self.LR*=0.1
        # self.LR*=0.1
        if (epoch+1) %10 ==0 and self.LR > 1e-5:
            self.LR *= 0.5
        if epoch>100 and self.LR > 1e-6:
            self.LR  *= 0.1
